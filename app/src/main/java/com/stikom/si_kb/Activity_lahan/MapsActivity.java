...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnKembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( MapsActivity.this, LokasiActivity.class);
    ...
    private void initCustomDialog(){
        customDialog = new Dialog(MapsActivity.this);
        customDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        customDialog.setContentView(R.layout.popup_koordinat);
        customDialog.setCancelable(true);

        txtInputName = customDialog.findViewById(R.id.userName);
        txtluas_lahan = customDialog.findViewById(R.id.luas_lahan);
        ...
        btnInsertName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String luaslahan = txtluas_lahan.getText().toString();
                nama_lokasi=name;
//                txtName.setText(name);
                customDialog.dismiss();
                TambahData(name,luaslahan);
            }
        });
    }
    ...
    private void TambahData(String nama, final String luaslahan) {
        if (nama.equals("") || luaslahan.equals("")) {
            Toast.makeText(MapsActivity.this,"Nama Lokasi/Luas Lahan Tidak Boleh Kosong",Toast.LENGTH_SHORT).show();
        }else{
                    class TambahData extends AsyncTask<Void, Void, String> {
                        ...
                        protected void onPreExecute() {
                            super.onPreExecute();
                            loading = ProgressDialog.show(MapsActivity.this, "Proses Kirim Data...", "Wait...", false, false);
                        }
