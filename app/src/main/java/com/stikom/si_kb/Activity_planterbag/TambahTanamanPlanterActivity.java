...
public class TambahTanamanPlanterActivity extends AppCompatActivity {
    JSONArray result;
    ...
    String id_lokasi,id_user,id_planter,id_pohon,nama,tanggal_tanam,panen,jml_panen,status,keterangan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_tanaman_planter);

        SharedPreferences sharedPreferences = TambahTanamanPlanterActivity.this.getSharedPreferences(Config.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        id_lokasi = sharedPreferences.getString(Config.LOKASI_SIMPAN_LOKASI, "null");
        id_planter = sharedPreferences.getString(Config.LOKASI_PLANTER_SIMPAN, "null");
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TambahTanamanPlanterActivity.this.checkSelfPermission(Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
        ...
        btnKembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( TambahTanamanPlanterActivity.this, PlanterBagActivity.class);
    ...
    private void initCustomDialog(){
        customDialog = new Dialog(TambahTanamanPlanterActivity.this);
        ...
        txtInputTanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(TambahTanamanPlanterActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btnInsertName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                customDialog.dismiss();
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(TambahTanamanPlanterActivity.this);
...
//                employees.put(Config.KEY_DATA_timestamp, timestamp);
            ...
            ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(TambahTanamanPlanterActivity.this,
    ...
    private void getJSONLokasi(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TambahTanamanPlanterActivity.this,"Fetching Data","Wait...",false,false);
            }
            @Override
    ...
    private void TambahDataTanaman(final String keterangannya) {
        class TambahData extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TambahTanamanPlanterActivity.this, "Proses Kirim Data...", "Wait...", false, false);
            }
...
//                    System.out.println("ININI "+id_lokasi+" "+id_user+" "+id_pohon+" "+nama+" "+tanggal_tanam+" "+panen+" "+jml_panen);
                ...
                params.put(Config.TAG_TANAMANKU_id_planter, id_planter);
                ...
                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(Config.TANAMAN_PLANTER_SIMPAN_URL, params);
                return res;
            }
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults)
    {
        ...
        if (requestCode == MY_CAMERA_PERMISSION_CODE)
        {
            ...
            {
                Toast.makeText(TambahTanamanPlanterActivity.this, "camera permission granted", Toast.LENGTH_LONG).show();
                Intent cameraIntent = new Intent(android.provider.MediaStore.ACTION_IMAGE_CAPTURE);
                startActivityForResult(cameraIntent, CAMERA_REQUEST);
            }
            else
            {
                Toast.makeText(TambahTanamanPlanterActivity.this, "camera permission denied", Toast.LENGTH_LONG).show();
            }
        }
    }
}